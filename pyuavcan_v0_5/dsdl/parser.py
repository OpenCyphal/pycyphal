...
class Type:
    ...
    Fields:
        full_name    Full type name string, e.g. "pyuavcan_v0_5.protocol.NodeStatus"
...
class CompoundType(Type):
    """
    Compound type description, e.g. pyuavcan_v0_5.protocol.NodeStatus.
    Fields:
    ...
    def get_normalized_definition(self):
        """Returns full type name string, e.g. 'pyuavcan_v0_5.protocol.NodeStatus'"""
...
def parse_namespaces(source_dirs, search_dirs=None):
    ...
    Example:
        ...
        >>> a = pyuavcan_v0_5.dsdl.parse_namespaces(['../dsdl/uavcan'])
        >>> len(a)
        77
        >>> a[0]
        pyuavcan_v0_5.Timestamp
        >>> a[0].fields
