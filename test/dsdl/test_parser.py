...
from pyuavcan_v0_5.dsdl import parser, parse_namespaces
from pyuavcan_v0_5.dsdl.common import DsdlException
...
class TestParseNamespaces(unittest.TestCase):
    ...
    def test_builtin(self):
        ...
        '''
        built_in_dir = '{}/../../pyuavcan_v0_5/dsdl_files/uavcan'.format(os.path.dirname(__file__))
