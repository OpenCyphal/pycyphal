...
class StreamParser:
    ...
    The OOB data reporting can be useful if the same serial port is used both for Cyphal and as a text console.
        ...
        for b in chunk:
            ...
            if b == SerialFrame.FRAME_DELIMITER_BYTE:
                ...
                if self._timestamp is None:
                    self._timestamp = timestamp  # https://github.com/OpenCyphal/pycyphal/issues/112
