...
# Version-specific so that we won't attempt to load packages generated by another version.
...
EMITTED_TRANSFER_ID_MAP_DIR = VERSION_SPECIFIC_DATA_DIR / 'emitted-transfer-id-maps'
# This is not a path but a related parameter so it's kept here. Files older that this are not used.
EMITTED_TRANSFER_ID_MAP_MAX_AGE = 10.0  # [second]
