...
def generate_package(root_namespace_directory:        _AnyPath,
                     ...
                     output_directory:                _AnyPath = DEFAULT_GENERATED_PACKAGES_DIR,
    ...
    First, add the ``output_directory`` to :data:`sys.path` to make its contents importable.
    ...
    :param output_directory: The generated Python package directory will be placed into this directory.
        ...
        The default is specific to the current version of the library.
