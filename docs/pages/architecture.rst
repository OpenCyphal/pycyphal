...
For example::
    ...
    >>> import pyuavcan
    >>> pyuavcan.dsdl.serialize         # OK, the DSDL submodule is auto-imported (most of them are).
    ...
    >>> import pyuavcan.application     # Likewise the application layer -- it depends on DSDL classes.
...
.. graphviz::
    ...
    digraph submodule_interdependency {
        ...
        dsdl            [fillcolor="#FF88FF"];
        transport       [fillcolor="#FFF2CC"];
        presentation    [fillcolor="#D9EAD3"];
        application     [fillcolor="#C9DAF8"];
        util            [fillcolor="#D3D3D3"];
